...
Let us create the data used by the stan file. 
...
and here we can see how the paramters alpha and beta are distributed
...
The $\widehat R_{\alpha}$ is `r round(diagnostics$Rhat[1],digits=2)`.00 and $\widehat R_{\beta}$ is `r round(diagnostics$Rhat[2],digits=2)`.00
