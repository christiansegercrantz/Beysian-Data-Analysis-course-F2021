...
From the table below, we can see that the posterior means are all still within the interval we got in the b part. When the prior knowledge, $\alpha + \beta$ is of the magnitude 500 is the posterior mean is barely outside the 90% interval.
